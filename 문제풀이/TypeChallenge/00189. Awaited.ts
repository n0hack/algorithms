...
type MyAwaited<T extends Promise<any> | Thenable<any>> = T extends Promise<infer InnerValue>
  ? InnerValue extends Promise<any>
    ? MyAwaited<InnerValue>
    : InnerValue
  : T extends Thenable<infer InnerValue>
  ? InnerValue extends Promise<any>
    ? MyAwaited<InnerValue>
    : InnerValue
  : never;
